        ...
        <div class="row justify-content-center px-2 py-2 rounded shadow p-3 mb-5 bg-white">
            ...
            <div class="row mb-3 mt-3">
                <div class="col-sm-4">
                    ...
                    <div class="mt-2" style="display: flex; align-items: center; font-size: small;">
                        
                        <p style="margin: 0; color: #999 font-size: 12px;">Download sample template for file import </p>
                        <a href="../preview/employee_preview.xlsx" download class="text-primary text-decoration-none ms-2" style="margin-right: 10px;">
