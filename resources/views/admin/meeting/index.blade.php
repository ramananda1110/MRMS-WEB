    ...
    <div class="row justify-content-center">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs">
                ...
                <a class="nav-link active" aria-current="page" href="{{ route('meetings.all') }}"  onclick="setActiveTab(event, this)">All</a>

                </li>
                <li class="nav-item">
                <a class="nav-link" href="{{ route('meetings.upcoming')}}"  onclick="setActiveTab(event, this)">Upcoming</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('meetings.pending') }}"  onclick="setActiveTab(event, this)" >Pending</a>
                </li>
