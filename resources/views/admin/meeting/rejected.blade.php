    ...
    <div class="row justify-content-center rounded shadow p-3 mb-5 bg-white" style="background-color: white">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs mt-3">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" href="{{ route('meetings.cenceled') }}" id="canceled" onclick="setActiveTab(event, this)" >{{__('messages.cancelled')}} </a>
                </li>

                <li class="nav-item" role="presentation">
                    <a class="nav-link active" href="{{ route('meetings.rejected') }}" id="rejected" onclick="setActiveTab(event, this)" >{{__('messages.rejected')}} </a>
                </li>
